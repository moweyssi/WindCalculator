...
def makedf(property_type, lat, lon, annual_consumption,start_year, end_year, turbine_height,land_cover_type):

    generation_hourly, error_hourly, yearly_generation, yearly_used  = PV_power(
        start_year,end_year,lat,lon,property_type, annual_consumption, turbine_height,land_cover_type
        )
